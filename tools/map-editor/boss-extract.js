...
var BOSS_SOURCES = {
  ...
  prehistory: {
    ...
    notes: [
      ...
      'structure also sets cardsPerTurn: 1 (line 367). draw is `{ model: \'flat\', perTurn: 2 }` — a flat +2/turn draw capped at maxHandSize (not \'replenish\'); Tool (id 26) is the one exception, its own reveal-phase draw can push the hand above the cap.',
